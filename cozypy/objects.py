...
class CozytouchDevice(CozytouchObject):
    ...
    @property
    def name(self):
        return self.get_state(DeviceState.NAME_STATE)
...
class CozytouchContactSensor(CozytouchDevice):
    ...
    @property
    def id(self):
        return self.parent.id + "_contact"
...
class CozytouchElectricitySensor(CozytouchDevice):
    ...
    @property
    def id(self):
        return self.parent.id + "_electricity"
...
class CozytouchTemperatureSensor(CozytouchDevice):
    ...
    @property
    def id(self):
        return self.parent.id + "_temperature"
...
class CozytouchOccupancySensor(CozytouchDevice):
    ...
    @property
    def id(self):
        return self.parent.id + "_occupancy"
